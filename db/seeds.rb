...
episodes = Episode.create([
                            { title: '1. Setting up new RoR app with React.', description: 'lorem ipsum', url: 'https://www.youtube.com/embed/5F_JUvPq410', section: section },
                            { title: '2. Add React to existing RoR app.', description: 'lorem ipsum', url: 'https://www.youtube.com/embed/5F_JUvPq410', section: section },
